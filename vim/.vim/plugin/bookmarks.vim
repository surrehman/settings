...
"
"
"  " some hackerky to get customized bookmark names"
"  let @x=inputdialog("Enter bookmark name")
"  let @x = substitute(@x,"\\s\\+"," ","g")
"  let @x = substitute(@x,"^\\s\\+\\|\\s\\+$","","g")
"  let @x = strpart(@x, 0, 35)
"  if @x == ""
"    let @x = "Line number " . l:lineNo
"  else
"    let @x = @x . ' (' . l:lineNo . ')'
"  endif
...
"  " end of hackery"
"
"  let @b = @b . l:fname . '.\ ' . @x . ' :e +' . l:lineNo . ' ' . l:fpath . '<CR>'
"  
